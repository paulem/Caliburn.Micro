    ...
    public class NameTransformer : BindableCollection<NameTransformer.Rule>
    {
        ...
        public class Rule
        {
            ...
            public Regex GlobalFilterPatternRegex
            {
                get
                {
                    return globalFilterPatternRegex ??
                           (globalFilterPatternRegex = new Regex(GlobalFilterPattern, options));
                }
            }
            ...
            {
                get { return replacePatternRegex ?? (replacePatternRegex = new Regex(ReplacePattern, options)); }
            }
        }
    }
}